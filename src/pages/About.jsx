...
IT Specialist with a Bachelor’s degree in Computer & Instructional Technologies
and 4+ years of experience in enterprise IT environments. Skilled in managing IT
infrastructure, optimizing system performance, and supporting business-critical
software solutions.

Certified in Harvard University's CS50x with strong foundations in software
development, databases, and system architecture.
</p>
...
<div className="glass p-6 rounded-xl">IT Infrastructure Management</div>
<div className="glass p-6 rounded-xl">System Performance Optimization</div>
<div className="glass p-6 rounded-xl">Enterprise Software Support</div>
<div className="glass p-6 rounded-xl">Database Administration</div>
<div className="glass p-6 rounded-xl">Technical Troubleshooting</div>
<div className="glass p-6 rounded-xl">Automation & Process Improvement</div>
...
<p>
Python application with SQL database integration and
...
<p>
Automation scripts to improve workflow efficiency and
system performance.
</p>
...
<span className="glass px-5 py-2 rounded-xl">
English 
</span>
