export default function Skills() {
  const skillGroups = [
...

    {
      ...
      skills: [
        { name: "Responsive Website Design", level: 100 },
        { name: "Modern UI Development", level: 100 },
        { name: "Portfolio & Business Websites", level: 100 },
        { name: "Website Performance Optimization", level: 100 },
      ],
    },

    {
      ...
      skills: [
        ...
        { name: "Website Performance Optimization", level: 90 },
      ],
    },
...

    {
      ...
      skills: [
        ...
        { name: "Performance Optimization", level: 100 },
      ],
    },
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-28">
          ...
          <div className="glass p-8 rounded-xl text-center max-w-xl mx-auto">
            ...
            <p className="text-gray-300 mb-1">(HarvardX)</p>

            <p className="text-orange-400">Verified Certificate – 2026</p>
          </div>
        </div>
      </div>
    </section>
