  ...
  return (
    <header className="fixed top-0 w-full z-50 backdrop-blur-xl bg-black/30 border-b border-white/10">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-5 md:px-8 py-4">
        ...
        <Link
          to="/"
          className="flex flex-col leading-tight md:flex-row md:items-center text-sm md:text-xl font-bold tracking-wide group relative"
        >
          <span className="text-white group-hover:text-orange-400 transition duration-300">
            Tansu Aksoy
          </span>

          <span className="hidden md:inline ml-2 bg-gradient-to-r from-orange-400 via-red-500 to-orange-400 bg-clip-text text-transparent">
            | IT Portfolio
          </span>
